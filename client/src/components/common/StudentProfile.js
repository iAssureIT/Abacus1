		           ...
		           <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					{/*this.props.packageOrderData.length>0?*/
						<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 profileSection12">									
							<div className="col-lg-10 offset-lg-1 zeropadding">
								<div className="col-lg-10 offset-lg-1 ">
									<div className="examlinks1 col-lg-12 pckgtitle1">
										...
										<div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 floatLeft nullPadding"><blink><a href="/PackageList" className="testtitle examlinks col-lg-12 col-md-12 col-xs-12 col-sm-12 pdcls" title="Click here to buy more packages">&nbsp; Buy New Packages</a></blink></div>											
									</div>
								</div>
