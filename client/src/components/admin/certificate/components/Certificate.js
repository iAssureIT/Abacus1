		              ...
		              <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12">
		                <div className="box">
		                  <div className="box-header with-border boxMinHeight">
		                 	<div className="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-6 offset-sm-3 col-xs-12 certicateCompWrap addTransitionCCW">
							       		...
							       		<div className="bg col-xl-12 col-lg-12 col-md-8 col-sm-12 col-xs-12 ">
							       			<div className="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-xs-4 certifywrapper">		
							       				<div className="col-xl-9 col-lg-9 col-md-9 col-sm-4 col-xs-4">
							   						<div className="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-xs-12 dispIn-blk">
							       						<img src="/images/logo.png" className="img-responsive certificateLogo" />
							       					</div>
							       					<div className="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 dispIn-blk">
								       					<div className="col-xl-12 col-lg-10 col-md-10 col-sm-12 col-xs-12 row titleCertify">
												...
												<div className="col-xl-9 col-lg-9 col-md-9 col-sm-4 col-xs-4">
													<p className="certifyLastLine col-xl-12 col-lg-12 col-md-12 col-sm-4 col-xs-12">in 6th Abacus International Championship-2019{/*this.state.examData.competitionName*/} of</p>
												</div>
												<div className="col-xl-9 col-lg-9 col-md-9 col-sm-4 col-xs-4">
												...
												<div className="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12  certificateSignWrapper">
													<div className="col-lg-5 col-xl-5 col-md-5 col-sm-12 col-xs-12 dispIn-blk">
